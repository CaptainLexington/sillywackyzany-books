...
I thought I might talk about _why_ I took Jo Walton's example and started reading 16 books at the same time, as well as why I might recommended this system, or a personalized variation on it, to other people. _Some_ other people! It is certainly not one-size-fits-all.

I adopted this system because I have many interests, and which of those interests I am currently in the mood to pursue is liable to change on short notice. I would pick up the book I'd been reading, filled slightly with dread, put it back down, and read again and again the backs of the other books continuing to pile up on my TBR. When can I start these, I'd ask myself? When I finish this one! Ugh! How could I at once be so uninterested in reading _and_ so impatient to read?

I realize now this was the feeling of no longer being interested---or not _primarily_ interested, not _solely_ interested---in the subject or the mood or the style of that specific book. I wanted to read, but I wanted to read something _else_, and I had this old-fashioned instinct that I needed to finish what I was currently reading before I could do so. This produced a feeling of stalemate, and I would give up reading entirely until the mood to continue my current book returned, or until I sheepishly DNF'd it and tried something else.
...
<div class="row mt-3">
    ...
    {% include figure.liquid loading="eager" path="assets/img/results.png" caption="The explosion of reading engendered by this change." class="img-fluid rounded z-depth-1" index=1 width="300px" %}
    </div>
</div>
...
As I mentioned in my [last post on this subject](/blog/2026/how-to-read-16-books/), shortly after I devised my own system based on Jo Walton's tantalizing hints, she revealed all [on her Reactor column](https://reactormag.com/how-to-read-sixteen-books-at-once-at-all-times/). You should go read it, because she's a good and funny writer, but I will summarize her system in a way that makes it easy to compare to mine. Slots that are the same in both are matched with dingbats:

<div style="display: flex;">
    <div style="flex: 1;">
        <h3>Jo Walton's System</h3>
        <ol>
            <li><i class="fa-solid fa-rocket"></i> A fantasy/science fiction novel. </li>
            <li><i class="fa-solid fa-signature"></i> A mainstream novel. </li>
            <li><i class="fa-solid fa-file-lines"></i> A collection of short stories. </li>
            <li><i class="fa-solid fa-book"></i> An anthology of short stories. </li>
            <li>A collection of poetry.</li>
            <li>An anthology of poetry.</li>
            <li><i class="fa-solid fa-envelope"></i> A collection of letters. </li>
            <li>Ditto. </li>
            <li>Something translated from Greek or Latin.</li>
            <li>A "relevant" history book (i.e. research for her historically-inspired fantasy novels)</li>
            <li><i class="fa-solid fa-landmark"></i> An "irrelevant" history book. </li>
            <li>A travel memoir. </li>
            <li>The Harvard Classics</li>
            <li>An epic narrative from antiquity.</li>
            <li>A primary source.</li>
    ...
    <div style="flex: 1;">
        <h3>My System</h3>
        <ol>
            <li><i class="fa-solid fa-rocket"></i> A fantasy/science fiction/historical novel.</li>
            <li>A crime novel.</li>
            <li>A Wodehouse novel.</li>
            <li><i class="fa-solid fa-signature"></i> Some other kind of novel.</li>
            <li><i class="fa-solid fa-book"></i> An anthology of short stories.</li>
            <li>Ditto.</li>
            <li><i class="fa-solid fa-file-lines"></i> A collection of short stories.</li>
            <li>Ditto.</li>
            <li>A book about science.</li>
            <li>A how-to manual.</li>
            <li><i class="fa-solid fa-landmark"></i> A book on the humanities.</li>
            <li>Ditto.</li>
            <li>A book of essays.</li>
            <li>A miscellany.</li>
            <li><i class="fa-solid fa-envelope"></i> A book of letters/memoir/biography.</li>
            <li>Ditto.</li>
        </ol>
    </div>
</div>
...
So that is how the system I designed compares to Jo Walton's to-me-at-the-time-mysterious original. More similarities than differences, but as noted by a friend of mine, the binary tree did _not_ have to be balanced.
...
My esteemed colleague Chris McMillen, Whatnot's inimitable [cmacfin](https://www.whatnot.com/user/cmacfin), has his own system: in his basement he has several piles of To-Be-Read in the various genres of his interest: when he chooses a book to read, it goes upstairs, to the bedroom or the study or whatever room he does his reading in, to sit in a stack with the representatives of each interest pile. Books finished are taken into deep storage, or sold, I suppose, and the newly emptied space is refreshed from the basement shelves.
